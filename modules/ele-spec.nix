...
{
  # options.thing = mkOption {
  #   type = types.bool;
  # };
  options.specPackages = mkOption {
    type = types.lazyAttrsOf types.package;
    description = "Activation packages for specializations.";
    default = {};
    visible = "shallow";
  };
  # options.eleSpec = mkOption {
  #   type = types.attrsOf (types.submodule {
  #     options = {
  #       # activationPackage = mkPackageOption pkgs "activation" {};
  ...
  config.specPackages = mkIf (config.specialisation != {}) (let
    f = _: v: v.configuration.home.activationPackage;
  in mapAttrs f config.specialisation);
}
